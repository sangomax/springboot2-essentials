...
import academy.devdojo.springboot2.util.UserCreator;
...
class AnimeControllerIT {
    ...
    private static UserCreator users;
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:"+port)
                    .basicAuthentication("adriano", "academy");
            return new TestRestTemplate(restTemplateBuilder);
        }
    }
    ...
    void list_ReturnsListOfAnimesInsidePageObject_WhenSuccessful() {
        ...
        devDojoUserRepository.save(users.USER);
    ...
    @Test
    @DisplayName("listAll returns list of anime object when successful")
    ...
    void findByName_ReturnsEmptyListOfAnime_WhenAnimeIsNotFound() {
        ...
        List<Anime> animes = testRestTemplateRoleUser.exchange("/animes/find?name=test", HttpMethod.GET, null,
                new ParameterizedTypeReference<List<Anime>>() {
                }).getBody();
    ...
    void delete_RemovesAnime_WhenSuccessful() {
        ...
        devDojoUserRepository.save(users.ADMIN);
